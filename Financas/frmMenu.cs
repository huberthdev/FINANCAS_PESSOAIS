...
namespace Setup.Financas
{
    public partial class frmMenu : Form
    {
        ...
        private void CarregarListaGastoClasseMesAtual()
        {
            ...
            sql += "UNION SELECT C.CLASSE, SUM(B.VALOR) AS VALOR, B.CLASSE AS NCLASSE FROM KEY_COMPRA_CREDITO B INNER JOIN CLASSE C ON B.CLASSE = C.CLASSE_ID WHERE EXTRACT(MONTH FROM b.DATA_compra) = " + mes + " AND EXTRACT(YEAR FROM b.DATA_compra) = " + ano + " AND b.VALOR > 0 GROUP BY C.CLASSE, B.CLASSE) GROUP BY CLASSE, NCLASSE";
